		...
		if (aName==null || toOtherName==null) {
			...
			{ 
	    		...
	    		try {
	    			...
	    			if (parse.getGenusOrAbove().equals(otherParse.getGenusOrAbove()) &&
	    				parse.getRank().equals(otherParse.getRank()) && 
	    				parse.getSpecificEpithet().equals(otherParse.getScientificName()) && 
	    				parse.getInfraSpecificEpithet().equals(otherParse.getInfraSpecificEpithet()) &&
	    				! parse.getInfraGeneric().equals(otherParse.getInfraGeneric())
	    					)  
	    					{
